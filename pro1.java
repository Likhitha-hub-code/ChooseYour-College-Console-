...
class Registration
{
	...
	static void login() 
	{
		...
		{
			System.out.println(green+"_______Login Successfully______"+stopcolor);
		}
		else
		{
			loginattempts++;
	...
	{
				System.out.println("_____"+bold+skyblue+blink+"WELCOME TO CHOOSE MY COLLEGE"+stopcolor+"_______");
		Home();
	}
...
class SBI extends A
{
	 ...
	 void payment(String upi)
	{
		...
		{
           		bal=bal-fee;
            		System.out.println(green+"_______Successful Transaction______"+stopcolor);
        	}
	}
	String paymentByAccount(long accno) 
	{
		...
		{
            		bal=bal-fee;
            		return green+"_______Successful Transaction______"+stopcolor;
        	}
    	}
...
class Union extends SBI
{
	...
	void payment(String upi)
	{
		...
		{
           		bal=bal-fee;
            		System.out.print(green+"______Successful Transaction________"+stopcolor);
        	}
	}
	String paymentByAccount(long accno) 
	{
		...
		{
            		bal=bal-fee;
            		return green+"________Successful Transaction________"+stopcolor;
        	}
    	}
	void payment(long mobno)
	{
