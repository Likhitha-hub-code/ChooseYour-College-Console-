...
class Registration
{
	...
	static void login() 
	{
		...
		{
			System.out.println(green+"________________________Login Successfully_____________________"+stopcolor);
		}
		else
		{
			loginattempts++;
			...
			{
				System.out.println(red+"Too many unsuccessful login attempts. Exiting."+stopcolor);
            			System.exit(0);
			}
		}
	}
	public static void Display() 
	{
			...
			System.out.println(red+blink+"Note:Username Shoulb Be 10 Digits"+stopcolor);
			System.out.println("Set Your UserName");
			obj.setUsername(sc.next());
			System.out.println(red+blink+"Note:Password Should Be Four Digits"+stopcolor);
	...
	{
				System.out.println("________________"+bold+skyblue+blink+"WELCOME TO CHOOSE MY COLLEGE"+stopcolor+"__________________");
		Home();
	}
...
{
	//abstract String payment(String upi);
	abstract String paymentByAccount(long accno);
	//abstract void payment(long mobno);
}	
class SBI extends A
{
	static Scanner sc = new Scanner(System.in);
	 ...
	 void payment(String upi)
	{
		...
		{
           		bal=bal-fee;
            		System.out.println(green+"________________________Successful Transaction_____________________"+stopcolor);
        	}
	}
	String paymentByAccount(long accno) 
	{
		...
		{
            		bal=bal-fee;
            		return green+"________________________Successful Transaction_____________________"+stopcolor;
        	}
    	}
...
class Union extends SBI
{
	...
	void payment(String upi)
	{
		...
		{
           		bal=bal-fee;
            		System.out.print(green+"_____________________Successful Transaction_______________________"+stopcolor);
        	}
	}
	String paymentByAccount(long accno) 
	{
		...
		{
            		bal=bal-fee;
            		return green+"___________________________Successful Transaction_______________________"+stopcolor;
        	}
    	}
	void payment(long mobno)
	{
		...
		if(c==10 && (r==6 || r==7 || r==8 || r==9))
		{
			...
			{
            			bal=bal-fee;
            			System.out.println(green+"____________________Successful transaction____________________"+stopcolor);
        		}
		}
		else
		{
...
class Mallareddy extends Managment
{
	...
	{
		System.out.println("****Welcome to College Details****");
		System.out.println();
